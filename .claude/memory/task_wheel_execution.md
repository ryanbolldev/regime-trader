...
**Still-open review findings (not critical): #5 missing-mark silently disables loss exit, #6 no alert on order-submit failure, #7 passive buy-to-close pricing, #9 no spread/liquidity sanity at execution. Plus: None-IV-rank should block not bypass.**
